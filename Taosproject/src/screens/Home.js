              ...
              <View
                ...
                <View style={{marginLeft: 20, marginRight: 20, marginTop: 50}}>
                  ...
                  <Text
                    ...
                    inspiration, and lots of good things in store. It's all
                    free.
                  </Text>
                  <TouchableOpacity activeOpacity={0.5} style={{marginTop: 15}}>
                    <Text
                  ...
                  <View style={{paddingTop: 50}}>
                    ...
                    <TouchableOpacity
                      ...
                      onPress={() => {
                        const newValue =
                          rotateFooterContentB._value == 0 ? 1 : 0;
                        Animated.timing(rotateFooterContentB, {
                          toValue: newValue,
                          duration: 300,
                          useNativeDriver: false,
                    ...
                    <TouchableOpacity
                      ...
                      onPress={() => {
                        const newValue =
                          rotateFooterContentC._value == 0 ? 1 : 0;
                        Animated.timing(rotateFooterContentC, {
                          toValue: newValue,
                          duration: 300,
                          useNativeDriver: false,
                    ...
                    <TouchableOpacity
                      ...
                      onPress={() => {
                        const newValue =
                          rotateFooterContentD._value == 0 ? 1 : 0;
                        Animated.timing(rotateFooterContentD, {
                          toValue: newValue,
                          duration: 300,
                          useNativeDriver: false,
